...
class Dashboard:
        ...
        def show_dropdown_result(value):
            ...
            if value is None:
                ...
                updated_div = html.Div(children=[
                    ...
                    dbc.Row(
                        [dbc.Col(self.sidebar, style={'display': 'inline-block'}),
                         dbc.Col(dcc.Graph(id=f'image-{0}', figure=self.figures[0]),
                                 style={'display': 'inline-block'}),
                         dbc.Col(dcc.Graph(id=f'image-{1}', figure=self.figures[1]),
    ...
    def get_images_figures(self, idx=0, img_count=2):
        self.figures = []
        for row in self.dataset.dataset[idx:idx + img_count].iterrows():
