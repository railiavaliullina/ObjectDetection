...
sidebar = html.Div(
    [
        ...
        dcc.Dropdown(
            ...
            searchable=False, style={'marginBottom': '2%'}, id="dropdown_0"
        ),
...
app.layout = html.Div(children=[
    dbc.Row([
        ...
        dbc.Col(html.H1('Object Detection Problem'), width=9, style={'marginTop': '1.5%'}),
    ]),
], id='main-part-div')
    ...
    if value is None:
        ...
        updated_div = html.Div(children=[
            ...
            dbc.Row(
                [
                    dbc.Col(
                        dcc.Graph(id='graph1', figure=px.pie(dataset.labeled_and_non_labeled_data_num, values='num_images',
